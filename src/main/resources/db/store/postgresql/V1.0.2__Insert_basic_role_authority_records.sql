...
INSERT INTO public.gc_role (code, created_at, created_by_id, id, updated_at, updated_by_id, description, ip, title) VALUES (104, null, null, 4, null, null, 'User Wallet', null, 'Wallet');

INSERT INTO public.gc_authority (code, created_at, created_by_id, id, updated_at, updated_by_id, authority_type, description, ip, title) VALUES (1001, null, null, 1, null, null, null, 'create proposal', null, 'create proposal');
